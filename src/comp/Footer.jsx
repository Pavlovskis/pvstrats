  ...
  return (
    <footer>
      ...
      <div class="bg-black text-white sm:flex justify-around">
        <div class="pt-16 px-16 sm:ml-16">
          <h1 class="text-xl font-roboto font-semibold mb-2">
            About Me 
          </h1>
          <div class="">
        ...
        <div class="mt-16 px-16 sm:mr-16">
          <h1 class="text-xl font-roboto font-semibold mb-2">
            Contacts
          </h1>
      ...
      <div class="pt-6 pb-3 bg-black text-neutral-500 font-roboto text-center">
        @2023 PV Strategies
      </div>
    </footer>
  )
